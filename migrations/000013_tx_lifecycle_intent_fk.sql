...
-- renumbered or rewritten. The named constraint is validated by PostgreSQL
-- (NOT NOT VALID), so pre-existing tx_attempts rows must already reference a
-- real payment_intents row (the joint fixture seeds them in FK order).
--
