...
- [X] T031 [P] Lint/vet/build gate (`go vet ./...`, repo lint, `go vet -tags integration ./internal/signer/...`) + 002–007 regression + migration diff allowlist. Deps: US1–US6. Done: green.
