...
| V11 | Unauthorized release attempts; restart vs pause; independent pauses | I | forged operator calls; manual pause-row delete; pre-existing drift pause | all refused; tamper backstop holds; independent pauses survive release (A10/A11 → SC-10/11) |
