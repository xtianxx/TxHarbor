...
Integration workspace creation + real-claim adapter swap + migration application + joint acceptance execution (J1–J5) are **OWNER-010** and live in `specs/010-transaction-lifecycle/tasks.md`; they are referenced here, never duplicated. The 010-side tasks were generated in parallel and the 010 file uses `011:TBD-<slug>` placeholders (its Phase 9 legend) that MUST be replaced by these concrete 011 IDs:
